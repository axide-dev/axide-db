/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: fcce1d3cee114aebb0d5849bf1e81137)
// Runtime types generated with workerd@1.20251210.0 2025-09-23 disable_nodejs_process_v2,nodejs_compat
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CLERK_SECRET_KEY" | "CLERK_FRONTEND_API_URL" | "CLERK_JWT_ISSUER_DOMAIN" | "CONVEX_DEPLOYMENT" | "NEXT_PUBLIC_CONVEX_URL" | "NEXT_PUBLIC_CLERK_PUBLISHABLE_KEY">> {}
}
